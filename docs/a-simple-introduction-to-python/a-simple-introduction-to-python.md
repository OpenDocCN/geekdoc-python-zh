...
![](img/876e8f6fb58e61a37e2bab648b369646_0_0.png)
...
*《Python 简明入门》* 面向大学预科学生和编程完全新手。全书使用 Jupyter 笔记本编写。在将 Python 介绍为强大的计算器之后，本书涵盖了简单的编程结构，并介绍了 NumPy、MatPlotLib 和 SymPy 模块（库）。随后，本书展示了如何将 Python 用于数学、密码学、人工智能、数据科学和面向对象编程。读者将学习如何使用集成开发环境进行编程：Python IDLE、Spyder、Jupyter 笔记本，以及通过 Google Colab 进行云计算。

**特点：**

-   无需任何编程经验。
-   演示如何为在 Web 上发布而格式化 Jupyter 笔记本。
-   练习的完整解答可作为 Jupyter 笔记本在 Web 上获取。
...
2022 年，**斯蒂芬·林奇** 被授予国家教学研究员称号，该称号旨在表彰和认可在高等教育中对学生成果和教学产生杰出影响的个人。他因其在 STEM 学科编程教学、研究反哺教学以及扩大参与度（利用体验式和基于对象的学习）方面的工作而获奖。尽管接受的是纯数学教育，但斯蒂芬的众多兴趣现在包括应用数学、细胞生物学、电气工程、计算、神经网络、非线性光学和二进制振荡器计算（他与同事共同发明）。他拥有 2 项国际发明专利、8 本书、4 本书章节、45 多篇期刊文章和一些会议论文集。斯蒂芬是数学及其应用研究所会士（FIMA）和高等教育学院高级会士（SFHEA）。他目前是曼彻斯特城市大学的高级讲师，并于 2008 年至 2012 年间担任开放大学的兼职讲师。2010 年，斯蒂芬自愿担任 STEM 大使；2012 年，他被授予曼彻斯特城市大学公共参与冠军称号；2014 年，他成为学校演讲者。他举办关于“面向 A-Level 数学及更高水平的 Python”的全国研讨会，以及关于“面向科学计算的 Python 和面向人工智能的 TensorFlow”的国际研讨会。他在中国、马来西亚、新加坡、沙特阿拉伯和美国举办过研讨会。
...
Python 已被列为最受欢迎的编程语言，并在教育和工业界得到广泛应用。本系列丛书将为学生和专业人士提供一系列关于 Python 的书籍。本系列的书籍将帮助用户在入门和高级水平上学习该语言，并探索其在数据科学、人工智能和机器学习中的众多应用。本系列书籍还可辅以 Jupyter 笔记本。
...
![](img/876e8f6fb58e61a37e2bab648b369646_3_0.png)
...
要获得复印或以电子方式使用本作品材料的许可，请访问 www.copyright.com 或联系版权结算中心 (CCC)，地址：马萨诸塞州丹弗斯罗斯伍德大道 222 号，邮编 01923，电话：978-750-8400。对于在 CCC 上不可用的作品，请联系 mpkbookspermissions@tandf.co.uk

*商标声明*：产品或公司名称可能是商标或注册商标，仅用于识别和解释，无意侵权。

**美国国会图书馆编目出版数据**
名称：Lynch, Stephen, 1964- 作者。
标题：Python 简明入门 / Stephen Lynch，曼彻斯特城市大学，英国。
描述：第一版。| 博卡拉顿：C&H，CRC 出版社，2024。|
系列：查普曼与霍尔/CRC Python 系列 | 包括参考文献和索引。
标识符：LCCN 2023056099（印刷版）| LCCN 2023056100（电子书）| ISBN 9781032751672（精装本）| ISBN 9781032750293（平装本）| ISBN 9781003472759（电子书）
主题：LCSH：Python（计算机程序语言）| 计算机编程。
分类：LCC QA76.73.P98 L963 2024（印刷版）| LCC QA76.73.P98（电子书）| DDC 005.13/3--dc23/eng/20240212 LC 记录可在 https://lccn.loc.gov/2023056099 获取
电子书记录可在 https://lccn.loc.gov/2023056100 获取

ISBN：978-1-032-75167-2（精装本）
ISBN：978-1-032-75029-3（平装本）
ISBN：978-1-003-47275-9（电子书）

DOI：10.1201/9781003472759

使用 Latin Modern 字体排版
由 KnowledgeWorks Global Ltd. 完成。

*出版商注*：本书由作者提供的照相排版稿编制而成。
...
- 7.1 凯撒密码 52
- 7.2 XOR 密码 53
- 7.3 Rivest-Shamir-Adleman (RSA) 密码系统 54
- 7.4 简单 RSA 算法示例 55
...
本书面向大学预科生或编程完全新手。这是我编写的第三本关于 Python 的书。最近的一本书，**《Python 科学计算与人工智能》[1]**，由 CRC Press 于 2023 年出版，面向高中生、本科生、研究生和科学家，专注于跨学科科学、计算建模、模拟和编程。更高级的书，**《使用 Python 的动力系统及其应用》[2]**，由 Springer International Publishing 出版，设定在本科高年级和研究生水平，详细涵盖了一些数学理论和研究。本书是 [1] 和 [2] 的前导，旨在为编程完全新手提供 Python 编程的温和入门。

在前言的第二部分，将向读者展示（众多方法中的）三种访问 Python 的方式。Python 集成开发学习环境（IDLE）适用于第 1 至 3 章。对于科学计算和第 4 至 10 章的内容，读者需要通过 Anaconda 使用 Jupyter notebooks 或 Spyder，或者通过云计算使用 Google Colab。

每章都提供示例和练习。为了理解编程，读者必须尝试这些练习。学习编程就像学习骑自行车——你必须摔倒很多次才能掌握这门艺术。预计会犯很多错误，从错误中学习，然后继续下一章。所有练习的完整解决方案和其他资源将通过 GitHub 提供，读者可以免费下载所有文件。还将有一个包含完整解决方案的网页，读者可以简单地复制粘贴代码并在 Python 环境中运行程序。读者应注意，Python 程序可以轻松地由 OpenAI 开发的 ChatGPT（聊天生成预训练转换器）以及其他替代方案（如 Microsoft Bing、Perplexity AI 和 Google Bard AI）生成。读者应该问问这些 AI 聊天机器人为什么人类应该学习编程——它们给出了一些非常有力的论据。

第 1 章向读者展示如何将 Python 用作简单而强大的计算器，并介绍了第一个库（或模块）。Math 库包含可以在 Python 中调用的函数（用 Python 编写）。其中一些函数对大多数读者来说很熟悉（asin、sin、exp、gcd、lcm、sqrt 等），一些不熟悉的函数（ceil、floor、fmod、radians、trunc）将在此定义。第 2 章从列表、元组、集合和字典开始，然后转向简单编程、定义函数（想象为你的 Python 计算器添加按钮）、循环和条件构造（if、elif、else）。在第 3 章中，将 turtle 库加载到笔记本中，并使用递归函数和迭代绘制简单的分形（在不断缩小的尺度上重复的图像）。第 4 章在处理数组、矩阵、向量、张量和绘图时使用了数值 Python（NumPy）和矩阵绘图库（MatPLotLib）。第 5.1 节介绍了使用 Google Colab（协作实验室）进行云计算，读者可以在自己的计算机上无需安装任何软件即可使用 Jupyter notebooks。下一节向读者介绍如何格式化笔记本，使用 LaTeX 插入标题、图形和数学方程。接下来介绍了用于符号计算的符号 Python（SymPy）库，最后一节向读者展示如何访问 GitHub，这个 AI 驱动的开发者平台，用于构建、扩展和交付安全软件。除了在这里存储和共享 Python 程序外，读者还应该知道它也提供了一个发布自己网页的平台——正如作者为其个人网页和本书解决方案所做的那样。

第 6 章向读者展示 Python 如何帮助理解基础数学。使用 Python 可以帮助更深入地理解数学，我强烈主张将其引入世界各地的所有学校课程。它不仅可以帮助理解，而且可以带来很多乐趣——这是许多儿童数学教育中所缺乏的！第 7 章从一些著名的历史密码开始，以 Rivest-Shamir-Adleman (RSA) 算法的简单示例结束，提供了密码学和网络安全的基础介绍。第 8 章讨论了通过人工神经网络（ANNs）实现的人工智能（AI）。有用于逻辑中与、或和异或门的简单 ANNs，并使用一个非常简单的 ANN 解释了反向传播算法。讨论了 1970 年代著名的波士顿房价数据集，并在解决方案笔记本中提供了波士顿房价 ANN 的完整工作程序。作为数据科学的入门，第 9 章从 Python 和数据分析（PANDAS）库开始，然后向读者展示如何加载、预处理数据、可视化呈现数据、探索数据以及分析和传达结果的示例。本章使用了四个大型数据集（LDSs），所有 LDSs 都可以通过 GitHub 下载。

第 10 章简单介绍了面向对象编程（OOP），这是一种与前面章节中遇到的函数式和过程式编程不同的编程风格。该概念基于包含数据（属性）和代码（方法）的对象。使用学生、员工和车辆对象，简要解释了封装、继承和多态的概念。练习中列出了一个打砖块游戏 OOP 的示例，并在解决方案笔记本中提供了该游戏的完整工作程序。
...
有关生物学、化学、数据科学、经济学、工程学、分形与多重分形、图像处理、常微分方程和偏微分方程的数值方法、物理学、统计学和人工智能（AI）的应用，请参阅 [1]。有关连续和离散动力系统的理论和应用的更多信息，请读者参阅 [2]。
...
对于本书，有三种通过互联网访问 Python 的简便方法。第一种是使用 Python IDLE，它在全球的学校中都很流行。第二种是通过 Anaconda Navigator，用户可以使用 Jupyter notebooks 和 Spyder（科学 Python 开发环境）。第三种流行的访问 Python 的方式是通过云计算使用 Google Colab。读者需要一个 Google 帐户才能使用 Colab。网上有许多免费视频演示如何使用这些工具。在此，我将对每一种进行简要介绍。

1.  Python 集成开发学习环境（IDLE）：适合初学者和在校学生。访问 Python IDLE 的网址是：
    https://www.python.org。

    图 1 展示了 Python 主页，读者可以在此下载 Python IDLE。下载 Python IDLE 后，读者可以点击 IDLE 图标（见图 2 左侧），加载一个 IDLE Shell，读者可以在其中将 Python 用作计算器。要编写程序（如第 2 章和第 3 章所示），可以像打开 Word 文档一样打开一个无标题的编辑器窗口。然后可以像在 Microsoft 中保存文件一样保存该文件。

    对于科学计算以及第 4 章到第 10 章涵盖的内容，读者需要下载 Anaconda（一个用于科学计算的 Python 和 R 编程语言发行版，旨在简化包管理和部署）或通过 Google Colab 使用云计算。

    ![](img/876e8f6fb58e61a37e2bab648b369646_13_0.png)
...
![](img/876e8f6fb58e61a37e2bab648b369646_13_1.png)

图 2 Python IDLE Shell，读者可以像使用计算器一样使用 Python。参见[第 1 至 3 章](#)。

# xvi ■ 前言

![](img/876e8f6fb58e61a37e2bab648b369646_14_0.png)

图 3 Anaconda 的主页。

Anaconda Navigator 图标会打开 Anaconda Navigator 窗口；参见图 4，读者可以使用 JupyterLab、Jupyter Notebook 和 Spyder。本书不使用其他数据科学和统计包。

图 5 展示了在 Apple Mac 上以浅色模式运行的 Spyder 环境。熟悉 MATLAB® 的读者会注意到这里的相似之处。编辑器窗口是用户编写 Python 程序的地方。右上角的窗口可以获取帮助、探索变量、查看绘图和查看文件夹中的文件。控制台窗口是 Python 可以用作计算器的地方。
...
![](img/876e8f6fb58e61a37e2bab648b369646_15_0.png)

图 4 Anaconda Navigator 窗口，本书我们只使用 JupyterLab、Jupyter Notebooks 和科学 Python 开发环境（Spyder）。

![](img/876e8f6fb58e61a37e2bab648b369646_15_1.png)

图 5 在 Apple Mac 上以浅色模式运行的 Spyder 环境。

# xviii ■ 前言

![](img/876e8f6fb58e61a37e2bab648b369646_16_0.png)
...
**3. Google Colab：** 要进行云计算并访问 Google Colab，您需要一个 Google 帐户：

![](img/876e8f6fb58e61a37e2bab648b369646_16_1.png)

图 7 一个无标题的 Jupyter notebook。顶部单元格是一个 Markdown 单元格。In [1]: 是一个代码单元格，Out[1]: 显示单元格**运行**后的输出。也可以在代码单元格中点击 **SHIFT + ENTER**。

https://colab.research.google.com/。

![](img/876e8f6fb58e61a37e2bab648b369646_17_0.png)

图 8 打开 Google Colab 时出现的窗口。通过点击蓝色框中的 + **New notebook** 创建一个新的 Jupyter notebook。

图 8 展示了启动 Google Colab 时打开的窗口。这假设您已经登录了您的 Google 帐户。只需点击页面底部的 **New notebook** 即可获得一个 Google Colab Jupyter Notebook，如图 9 所示。

在图 9 中，Markdown 单元格尚未执行，但 Colab 显示了输出结果。请注意，html 使用 # 符号表示

![](img/876e8f6fb58e61a37e2bab648b369646_17_1.png)

图 9 一个 Google Colab Jupyter notebook。顶部单元格是一个文本单元格，[1] 是一个代码单元格。

# xx ■ 前言

![](img/876e8f6fb58e61a37e2bab648b369646_18_0.png)
...
![](img/876e8f6fb58e61a37e2bab648b369646_19_0.png)
...
- (b) $2 \times 3$;
- (c) $3 \times (2 - 5)$;
- (d) $2 + 3 \times (6 + 2 \times 5) - 8$;
- (e) $\frac{1}{2} \times (\frac{1}{3} - \frac{1}{4})$。

以下解决方案使用 Jupyter notebook 计算。In [1]: 是一个代码单元格；如果您点击 **SHIFT + ENTER**，则该单元格被执行，结果为 Out[1]:。
...
下面的示例与上面在同一个 Jupyter notebook 中，因此从代码单元格 In [6]: 开始。要执行每个单元格，读者点击 **SHIFT + ENTER**。

**示例 1.2.1.** 计算以下内容，将答案保留为分数：

- (a) $\frac{1}{2} + \frac{1}{3}$;
- (b) $\frac{1}{2} \times 8$;
- (c) $\frac{1}{3} \times \frac{2}{5}$;
...
![](img/876e8f6fb58e61a37e2bab648b369646_25_0.png)

## 2.1 列表、元组、集合和字典

Python 中有四种内置数据类型，分别是列表、元组、集合和字典。现在将逐一定义：

**列表**是一个有序且可更改的元素集合，允许重复元素。例如，[1, 2, 3, 3, 4, 5] 是一个包含六个元素的列表。请注意使用了方括号和从零开始的索引。

**元组**是一个有序且不可更改的元素集合，允许重复元素。元组通常用于异构（不同）的数据类型。例如，(4,5,42,6,6,“cherry”,“date”) 是一个包含六个元素的元组。请注意使用了圆括号和从零开始的索引。
...
![](img/876e8f6fb58e61a37e2bab648b369646_28_0.png)
...
计算出的圆柱体体积为251.32741228718345立方厘米。请记住在调用函数之前运行模块。

**示例 2.2.3.** 使用Python IDLE，定义一个将摄氏度转换为开尔文的函数。执行程序时，输入温度，并输出带有八位占位符和四位小数的结果。在格式化中，命令**{:08.4f}**会输出带有八位占位符和四位小数的结果。

![](img/876e8f6fb58e61a37e2bab648b369646_29_0.png)

![](img/876e8f6fb58e61a37e2bab648b369646_29_1.png)
...
![](img/876e8f6fb58e61a37e2bab648b369646_30_0.png)

斐波那契数列的前二十项显示在右下角的控制台窗口中。

**偏好设置：** 通过点击**python**按钮（左上角），读者可以访问偏好设置，用户可以在其中进行各种选项设置，包括设置字体大小以及在浅色或深色模式下工作。上面的Spyder界面显示的是浅色模式。

**编辑器窗口：** 此窗口显示在Spyder界面的左栏，是用户编写Python程序的地方。请记住**运行**文件。在定义函数时，必须在控制台窗口中调用之前先运行文件。用户也可以**取消停靠**此窗口，以在计算机屏幕上获得更多空间。**重新停靠**将重新停靠该窗口。
...
![](img/876e8f6fb58e61a37e2bab648b369646_31_0.png)
...
读者应注意，这是云计算，您需要连接互联网才能使用Colab。在右上角，RAM和磁盘图标旁边的绿色勾号表示您已**连接到托管运行时**，换句话说，您已连接到云端。通过点击**运行时**，用户可以重启运行时并清除内核，以从[1]重新开始。所有存储的变量都将丢失。如果程序挂起或出现其他问题，程序员通常需要**重启内核**。
...
**编写网页：** 打开Jupyter notebook使读者能够将文件下载为网页（网页以.html结尾）。然后你可以通过GitHub将notebook发布到网上。读者可以轻松地在网上找到说明。
...
1.  列表和字典：
    ...
    (c) 使用**range**函数，构造一个形如 [−9, −5, −1, . . . , 195, 199] 的列表。
    (d) 创建一个汽车的字典数据类型，包含键值对：品牌:BMW，年份:2018，颜色:红色，里程:30000，燃料:汽油。

2.  编写一个将开尔文转换为摄氏度的函数，结果保留四位有效数字。

3.  使用**def**定义数学函数：
    (a) 定义sigmoid函数，其公式为：$\sigma(x) = \frac{1}{1+e^{-x}}$。计算$\sigma(0.5)$。这是人工智能中使用的激活函数。
    (b) 定义hsgn函数，如下所示：
    $$
    \text{hsgn}(x) = \begin{cases} 
    1 & \text{if } x > 0 \ 
    0 & \text{if } x = 0 \ 
    -1 & \text{if } x < 0.
    \end{cases}
    $$
    编写一个定义此函数的Python程序，并计算hsgn(−6)。

4.  较长的Python程序：
    (a) 编写一个交互式Python程序来玩“猜数字”游戏。计算机应生成一个1到20之间的随机整数，用户（玩家）必须在六次尝试内猜出这个数字。程序应让用户知道猜测是太高还是太低。读者将需要random库中的**randint**函数。
    (b) 考虑毕达哥拉斯三元组，即满足$a^2 + b^2 = c^2$的正整数$a, b, c$。假设$c$由$c = b + n$定义，其中$n$也是一个整数。编写一个Python程序，对于给定的$n$值，找出所有这样的三元组，其中$a$和$b$都小于或等于某个最大值$m$。对于$n = 1$的情况，找出所有满足$1 \le a \le 100$和$1 \le b \le 100$的三元组。对于$n = 3$的情况，找出所有满足$1 \le a \le 200$和$1 \le b \le 200$的三元组。
...
# Turtle.png 应加载到Colab文件夹中。
from google.colab import files
from IPython.display import Image
Image("Turtle.png", width = 600)
```

![](img/876e8f6fb58e61a37e2bab648b369646_35_0.png)
...
从一个实心的等边三角形开始。在每个阶段，移除倒置的中心等边三角形。
...
1.  绘制康托尔集的一个变体，其中在每个阶段移除两条中间线段。因此，在每个阶段，一条线段被替换为三条线段，每条线段的长度是前一条线段的五分之一。
2.  绘制一个科赫正方形分形，其中在正方形的每条边上，一条线段被替换为五条线段，每条线段的长度是前一条线段的三分之一。
3.  绘制一个三分叉树分形。
4.  绘制一个谢尔宾斯基正方形分形，其中在每个阶段移除一个中心正方形，并且长度尺度减少三分之一。
...
**NumPy 中的向量化计算：** NumPy 数组中有一种单一的数据类型，这允许进行向量化。就读者而言，可以使用大量计算机内存的 for 和 while 循环，可以被向量化形式所取代。作为一个简单的例子，考虑数字列表 $a = [1, 2, 3, \dots, 100]$，假设我们希望计算 $S_{100} = \sum_{n=1}^{100} a_i$。那么使用 for 循环，代码将是：
...
**示例 4.2.1。** 使用 MatPlotLib 绘制曲线 $y = x^2$，其中 $-2 \leq x \leq 2$。使用每平方英寸 300 点（dpi）的分辨率将图形保存为 **Parabola.png**。
...
Google Colab 界面在前言中已展示。Colab 的主要优势在于，用户无需在计算机上安装任何软件，并且可以在任何有互联网连接的地方访问。
...
下面在笔记本中列出了一些示例。请注意，LaTeX 命令位于美元符号之间。

有关 LaTeX 的更多信息，请读者参阅 Overleaf：

https://www.overleaf.com/，

这是一个易于使用且免费的在线协作 LaTeX 编辑器。

**插入图形：** 在 Google Colab 中插入图形的命令已在[第 3 章](https://example.com)中给出。下图展示了如何在 Jupyter 笔记本中插入图形。请注意，图形文件“Python Logo.png”必须与 Jupyter 笔记本保存在同一文件夹中。

```html
<!-- HTML 代码 -->
文件“Python Logo.png”必须与 Jupyter 笔记本（.ipynb）保存在同一文件夹中。

<figure>
<img src="Python Logo.png" width="600">
</figure>
```

### 5.3 符号 Python（SYMPY）

SymPy 是一个完全用 Python 编写的计算机代数系统和符号数学 Python 库。更多信息，请参阅 sympy 帮助页面：

https://docs.sympy.org/latest/index.html。

以下示例取自代数、微积分和矩阵。这些主题也将在下一章中涵盖。建议读者使用网络获取更深入的解释。使用 Python 可以更深入地理解数学。
...
代数是数学的一个分支，它操作或运算的是抽象符号而非数字。通常，十岁左右甚至更小的孩子就会开始接触代数。使用 Python 可以帮助更深入地理解数学。
...
3.  在同一张图上绘制直线 $\ell_1 : 2y = 4x + 5$ 和 $\ell_2 : 4y = 3x + 5$，并确定它们的交点。
...
2.  确定 $f(x) = 1$ 时的 $x$ 值。
3.  确定函数 $y = g(x) = \frac{2x-1}{x+1}$ 的反函数 $g^{-1}(x)$。在同一张图上绘制 $g(x)$ 和 $g^{-1}(x)$。
...
3.  积分，$I = \int 2x + 5 dx$。
4.  确定曲线 $y = 4x^3 - 3x^4$ 在 $x = 0.5$ 和 $x = 1$ 之间且位于 $x$ 轴上方的面积。绘制曲线并阴影表示该面积。
...
![](img/876e8f6fb58e61a37e2bab648b369646_69_0.png)

## 7.1 凯撒密码

凯撒密码是最简单的加密技术之一，常被儿童在学习发送秘密信息时使用。它是一种替换密码，其中明文中的每个字母都被字母表中固定位置之后的字母所替换。

![](img/876e8f6fb58e61a37e2bab648b369646_70_0.png)

https://en.wikipedia.org/wiki/Caesar_cipher.

Unicode 是一个通用的字符编码标准：

https://en.wikipedia.org/wiki/List_of_Unicode_characters.

Python 中的 `ord()` 函数接受一个单个 Unicode 字符的字符串参数，并返回其整数值。`chr()` 函数是 `ord()` 函数的逆操作。例如，`ord("A")` 是 65，而 `ord("a")` 是 97。

```python
# In [1]: The Caesar Cipher: Encryption.
shift = 3
...
下表是异或（XOR）函数的真值表。在 Python 中，使用的运算符是 **X^Y**，读作 X XOR Y。
...
**解.** &nbsp; 现在用二进制表示，3 = 0011，6 = 0110。对各列使用按位异或：
...
**示例 7.2.2.** 使用 Python 进行 XOR 密码的加密和解密。

**解.** 程序如下：

```python
# In [3]: XOR Cipher - Encryption and Decryption.
# The same function is used to encrypt and decrypt.
def EncryptDecrypt(text):
    XORKey = "A"
    length = len(text)
# Perform XOR operation of key with every character.
...
if __name__ == "__main__":
    ...
    EncryptDecrypt(sampletext)              # Decrypt.
```

加密字符串: [])$a[]9"-42(7$a[]3a[](1)$3

解密字符串: The Exclusive Or Cipher

## 7.3 RIVEST-SHAMIR-ADLEMAN (RSA) 密码系统

基本上，RSA 依赖于将两个大素数的乘积进行因式分解的问题（在工业中，每个素数通常有 10^300 位数字），而破解 RSA 加密被称为 RSA 问题。更多详情请参见维基百科：

https://en.wikipedia.org/wiki/RSA_(cryptosystem).

**定义 7.3.1：** 素数是只能被自身和 1 整除的数。

**定义 7.3.2：** 给定一个整数 $k > 1$，称为**模数**，两个整数 $m$ 和 $n$，如果 $k$ 是它们差的除数，则称它们在模 $k$ 下**同余**，即 $m - n = rk$，其中 $r$ 是一个整数。

**定义 7.3.3：** 模 $k$ 的同余写作：$m \equiv n \pmod{k}$。
...
1. 选择两个大素数，$p$ 和 $q$。
2. 计算 $n = p \times q$。
3. 欧拉函数给出为：$\phi(n) = (p - 1) \times (q - 1)$。
4. 选择公钥 $e$，使得 $2 < e < \phi(n)$，且 $\gcd(e, \phi(n)) = 1$；即 $e$ 和 $\phi(n)$ 互质。
5. 公钥和私钥满足同余式 $d \equiv e^{-1} \pmod{\phi(n)}$，其中 $d$ 是使用 EEA 计算出的私钥。

## 7.4 简单的 RSA 算法示例

RSA 加密和解密算法可以总结为以下步骤：

1. **Bob** 遵循上述 RSA 算法中的步骤 1 到 5。
2. **Alice** 计算 $E = m^e \pmod{n}$，其中 $m$ 是消息，$E$ 是加密后的消息，并将 $E$ 发送给 Bob。
3. **Bob** 计算 $D = E^d \pmod{n}$，其中 $D$ 是解密后的消息。

历史上，Alice 和 Bob 是用于解释 RSA 加密方法工作原理的虚构人物的名字。

**示例 7.4.1.** 为说明目的选择两个小素数。在实际应用中，会选择非常大的素数。Bob 选择素数 $p = 17$ 和 $q = 29$，以及公钥 $e = 11$。Alice 希望将数字（消息）20 发送给 Bob。发送的加密消息是什么？确认 Bob 正确解密了消息。

**输入/输出 代码单元格**

```python
In [4]: # Check that p and q are prime.
       from sympy import *
...
**面向 A-Level 数学及更高阶的 Python：** 我在网上发布了一个 Jupyter notebook，展示了 Python 如何涵盖英国 A-Level 数学的全部教学大纲：
...
3. 函数：
    ...
    (d) Logistic 映射函数由 $f_{\mu}(x) = \mu x(1 - x)$ 给出，计算 $f_{\mu}(f_{\mu}(x))$。
4. 微积分：
...
人工智能（AI）是指行为方式与人脑类似的计算系统。

![](img/876e8f6fb58e61a37e2bab648b369646_77_0.png)
...
![](img/876e8f6fb58e61a37e2bab648b369646_78_0.png)

这种单神经元 ANN 也被称为感知器。对于人工智能中的难题，ANN 由许多层组成，每层包含许多神经元，这些被称为深度学习 ANN。人工智能的灵感来源于人脑中神经元的动态活动。
...
![](img/876e8f6fb58e61a37e2bab648b369646_79_0.png)
...
![](img/876e8f6fb58e61a37e2bab648b369646_80_0.png)
...
在本章末尾的练习中，你将被给予权重和偏置，并被要求编写一个异或门 ANN 的 Python 程序。

![](img/876e8f6fb58e61a37e2bab648b369646_81_0.png)
...
下图展示了一个用于演示人工智能中前馈和反向传播如何工作的 ANN。

![](img/876e8f6fb58e61a37e2bab648b369646_81_1.png)

在迄今为止考虑的示例中，ANN 的权重是给定的，但如果我们没有被给予这些权重怎么办？误差反向传播算法用于确定这些权重。为了说明该方法，考虑上图并使用传递函数 $\sigma(v)$，此外假设偏置 $b_1$ 和 $b_2$ 是常数。假设我们希望更新权重 $w_1$ 和 $w_2$。最初，随机选择权重，数据通过网络前馈，不可避免地会产生误差。在此示例中，我们使用均方误差。接下来，使用反向传播算法更新权重以最小化误差。因此，使用微积分中的链式法则：
...
读者应注意，这里使用了偏微分，因为误差 $Err$ 是 $y, \sigma, o_i, h_i$ 和 $w_i$ 的函数，其中 $o_i, h_i$ 分别是输出和隐藏激活电位。基本思想是使误差 $Err$ 相对于权重 $w_1$ 和 $w_2$ 最小化。注意，为了简化，假设偏置 $b_1, b_2$ 是常数。
...
为了加密和解密，必须计算 $x^y \mod(z)$。在 Python 中，我们使用内置函数 **pow(x,y,z)**，它接受三个参数。
...
- 2. 在网上研究 Playfair 密码：https://en.wikipedia.org/wiki/Playfair_cipher。使用你的名字和姓氏作为加密和解密密钥（字母不重复），并完成一个 $5 \times 5$ 的数组表，省略字母 J。例如，如果你的名字是 **Bruce Wayne**，数组将如下所示：

$$\begin{pmatrix} B & R & U & C & E \\ W & A & Y & N & D \\ F & G & H & I & K \\ L & M & O & P & Q \\ S & T & V & X & Z \end{pmatrix}.$$

写下 Playfair 密码的规则。给定消息是 “I LOVE PYTHON”，手动确定加密消息。使用字母 X 表示空格。

- 3. 在网上研究维吉尼亚密码：https://en.wikipedia.org/wiki/Vigenere_cipher。编写一个 Python 程序来使用此密码加密消息。
- 4. 对于对密码学感兴趣的人，进行文献搜索：
...
该数据最初由哈里森（Harrison, D.）和鲁宾菲尔德（Rubinfeld, D.L.）于1978年发表，题为“享乐价格与清洁空气需求”，《环境经济学与管理杂志》，第5卷，第81-102页。数据集包含506个房屋的14个属性，是一个小型数据集。属性包括按城镇划分的人均犯罪率、一氧化二氮浓度（千万分之一）、放射状公路可达性指数等，目标数据是自住房屋的中位价值（以千美元计）。波士顿住房数据以及一个完整的波士顿住房人工神经网络计算器程序，可通过作者的GitHub网站下载：

https://github.com/proflynch/A-Simple-Introduction-to-Python，

其中数据文件标记为“housing.txt”，Python程序名为“Boston-Housing-ANN-Calculator.ipynb”。训练完成后，该人工神经网络可用于评估新增到数据集中的房屋价值。请注意，此数据来自1978年，因此已过时。

读者应注意，即使数据已被用于测试算法多年，也未必总是准确的！例如，目标数据似乎在50.00处被截断（对应中位价格5万美元）；截断的迹象在于，报告的中位价格恰好为5万美元的案例有16例，而价格在4万至5万美元之间、四舍五入到最近百位的案例有15例。哈里森和鲁宾菲尔德并未提及任何截断。

读者可能对专业的Python人工智能深度学习框架**TensorFlow**和**PyTorch**感兴趣。TensorFlow是一个非常强大且成熟的深度学习框架，而PyTorch相对较新，具有更强的社区驱动力，并且对Python更友好。关于人工智能、机器学习、深度学习和TensorFlow的更多信息，读者可参阅我在前言中引用的著作《Python在科学计算与人工智能中的应用》。

(ii) 使用反向传播算法更新权重 $w_{13}$ 和 $w_{23}$，假设偏置为常数。
...
2. 证明异或门人工神经网络在给定以下参数时，能很好地近似异或门：
...
3. 使用反向传播更新示例8.3.1中异或门人工神经网络的权重 $w_{11}, w_{12}, w_{21}$ 和 $w_{22}$。

4. 从GitHub下载“Boston-Housing-ANN-Calculator.ipynb”笔记本：

https://github.com/proflynch/A-Simple-Introduction-to-Python。

运行笔记本中的单元格，创建一个用于评估1978年波士顿郊区房屋价值的人工神经网络。程序中使用了三个属性（平均房间数、放射状公路可达性指数、低社会经济地位人口百分比）。目标数据是自住房屋的中位价值。
...
![](img/876e8f6fb58e61a37e2bab648b369646_86_0.png)

右侧的数据科学周期展示了一个典型的工作流程算法。

## 9.1 PANDAS简介

Python数据分析库（PANDAS）是一个用于解决实际问题的开源Python包。更多信息可在此处找到：

https://pandas.pydata.org。

示例9.1.1。创建一个关于健身房会员满意度的数据框。Out[1]列出了名为df的数据框。注意，日期被设置为索引。
...
![](img/876e8f6fb58e61a37e2bab648b369646_88_0.png)
...
在本节中，我们处理真实世界的数据。我们使用Data-1-OCR.xlsx，这是英国OCR考试机构用于A-Level考试的数据。读者可以从GitHub下载该Excel文件：
...
```
In [7]: df.shape # DataFrame的维度。

Out[7] (236, 22)
```

```
In [8]: df.info() # 关于DataFrame的信息。
...
小提琴图的作用与箱线图类似。它显示了定量数据在一个（或多个）分类变量的多个层级上的分布，以便可以比较这些分布。与箱线图（其中所有绘图组件都对应于实际数据点）不同，小提琴图的特点是底层分布的核密度估计。这可以是一种有效且吸引人的方式来同时显示多个数据分布，但请记住，估计过程会受到样本量的影响，对于相对较小的样本，小提琴图可能看起来平滑得具有误导性。

**示例 9.4.1.** 创建按地区分组的2010年出生时预期寿命的小提琴图。

```
In [10]: sns.violinplot(data=df, x="Life expectancy at \n            birth 2010", y="Region")
```

![](img/876e8f6fb58e61a37e2bab648b369646_93_0.png)

图 9.1 Out[10]: 小提琴图，与之前的箱线图进行比较。

图 9.1 显示了小提琴图。

散点图对于查看两个变量之间的相关性很有用。每个点的坐标由 DataFrame 的两列定义，并使用实心圆来表示每个点。在下面的示例中，点按地区进行颜色编码。**aspect** 函数在图表参数中更改宽度与高度的比例。

**示例 9.4.2.** 创建人均 GDP（美元）与2010年出生时预期寿命的散点图，按地区进行颜色编码。

```
In [11]: sns.relplot(data=df, x="GDP per capita (US$)", \n                y="Life expectancy at birth 2010", \n                hue="Region", aspect=1.5)
```

![](img/876e8f6fb58e61a37e2bab648b369646_94_0.png)
...
**示例 9.4.3.** 绘制人均 GDP（美元）与2010年出生时预期寿命的六边形图。

```
In [12]: sns.jointplot(data=df, kind="hex", x="GDP per \n          capita (US$)", y="Life expectancy at birth 2010")
```

![](img/876e8f6fb58e61a37e2bab648b369646_95_0.png)

图 9.3 Out[12]: 人均 GDP（美元）与2010年出生时预期寿命的六边形分箱图。
...
- 1. 对于数据集 Data-1-OCR.xlsx，创建 GDP 与2010年出生时预期寿命的散点图，其中实心圆的大小由医生密度决定。你能得出什么结论？
- 2. 从 GitHub 加载数据文件 Data-2-Edexcel.csv。这个 LDS 包含英国气象局为五个英国气象站提供的天气数据样本。加载数据并设置数据框。探索数据。比较1987年与2015年五个气象站的日平均温度。解读结果。
- 3. 从 GitHub 加载数据文件 Data-3-AQA.xlsx。这个 LDS 取自英国交通部库存车辆数据库。加载数据并设置数据框。探索数据。仅为汽油车创建二氧化碳排放量与质量的散点图。解读结果。
- 4. 从 GitHub 加载数据文件 Data-4-OCR.xlsx。这个 LDS 包含四组数据：两组来自2001年和2011年的人口普查；两组关于通勤方式，两组显示人口年龄结构。加载数据并设置数据框。探索数据。添加一列，给出就业人口中骑自行车上班的人的百分比。创建按地区划分的骑自行车上班的工人百分比的箱线图。解读结果。

## 面向对象编程简介

面向对象编程（OOP）是一种基于“对象”概念的编程范式，对象可以包含数据和代码。数据以属性的形式存在，代码以方法的形式存在。

![](img/876e8f6fb58e61a37e2bab648b369646_97_0.png)
...
- 1. 安全性：使用封装的主要优点在于数据的安全性。封装保护对象免受未经授权的访问。它允许私有和受保护的访问级别，以防止意外的数据修改。
- 2. 数据隐藏：用户不会意识到幕后发生了什么。要修改数据成员，请调用 setter 方法。要读取数据成员，请调用 getter 方法。这些 setter 和 getter 方法的作用对用户是隐藏的。
- 3. 简洁性：它通过保持类的分离并防止它们彼此紧密耦合，简化了应用程序的维护。
...
**函数多态：** 一个可以在不同对象上使用的 Python 多态函数的例子是 `len()` 函数，它可以用于列表、集合、字符串、元组和字典。
...
- 4. 下图是 **Brick Breaker Game** 的截图。玩家左右移动挡板来击打球，球会从挡板、砖块和三面围墙反弹。如果球越过挡板，玩家就失去一条命。水绿色的砖块（最低层）被击中一次后破碎，番茄红色的砖块（中间层）被击中两次后破碎，草坪绿色的砖块（最高层）被击中三次后破碎。如果所有砖块都被摧毁，你就赢得了游戏。
    - (a) 列出创建 Brick Breaker Game 所需的至少五个对象、属性和方法。

(b) 从 GitHub 下载 “Brick-Breaker-Game.ipynb” 笔记本：

https://github.com/proflynch/A-Simple-Introduction-to-Python。

运行笔记本中的单元格来玩打砖块游戏。你能摧毁所有的砖块吗？

(c) 还有哪些物理量可以被建模，以使游戏更加逼真？

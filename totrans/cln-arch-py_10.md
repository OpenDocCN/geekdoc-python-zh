...
> 原文：[https://www.thedigitalcatbooks.com/pycabook-chapter-08/](https://www.thedigitalcatbooks.com/pycabook-chapter-08/)
...
[https://github.com/pycabook/rentomatic/tree/ed2-c08-s01](https://github.com/pycabook/rentomatic/tree/ed2-c08-s01)* 
...
*At this point we can open [http://localhost:8080/rooms](http://localhost:8080/rooms) with our browser and see the result of the HTTP request received by Nginx, passed to gunicorn, and processed by Flask using the use case `room_list_use_case`.*
...
*Through `config.set_section_option` we are adding relevant configuration values to the main Alembic INI file section (`config.config_ini_section`), extracting them from the environment variables. We are also importing the file that contains the SQLAlchemy objects. You can find documentation on this procedure at [https://alembic.sqlalchemy.org/en/latest/api/config.html](https://alembic.sqlalchemy.org/en/latest/api/config.html).*
...
*And indeed, if you open [http://localhost:8080/rooms](http://localhost:8080/rooms) with your browser you will see a successful response, but no data.*
...
*and open or refresh [http://localhost:8080/rooms](http://localhost:8080/rooms) with the browser to see the value returned by our use case.*

**Source code

[https://github.com/pycabook/rentomatic/tree/ed2-c08-s02](https://github.com/pycabook/rentomatic/tree/ed2-c08-s02)** 
